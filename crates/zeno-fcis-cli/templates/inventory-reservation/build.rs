...
fn main() {
    ...
    let schema = lower_schema(
        ...
        vec![
            ...
            // Capacity of each field, and the largest single movement; the
            // laws and `synthesis.json` state the same bounds.
            (stable(105), TypeKind::I128 { min: 0, max: 5 }),
            (stable(106), TypeKind::I128 { min: 1, max: 3 }),
