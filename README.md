...
- closed schema validation, root-only schema-bound envelope admission, deterministic Rust/Python adapters, negative codec vectors, cross-language replay, and content-addressed generation manifests;
