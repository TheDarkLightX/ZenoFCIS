...
- [language-neutral finite synthesis](docs/LANGUAGE_NEUTRAL_SYNTHESIS.md) with relational realizability checks, canonical hole search, Rust/Python emission, and separate exhaustive target conformance;
