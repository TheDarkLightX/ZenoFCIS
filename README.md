...
- closed schema validation, root-only schema-bound envelope admission, generated exact-schema and exact-catalog reconstruction, root-envelope smart constructors, envelope-bound generated transition startup, deterministic Rust/Python adapters, negative codec vectors, cross-language replay, and content-addressed generation manifests;
