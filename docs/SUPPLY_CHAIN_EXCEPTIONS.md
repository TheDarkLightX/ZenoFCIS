...
Status: retained informational exception for ZenoFCIS 1.0.0, reviewed again
on 2026-09-12 against the locked graph and current upstream metadata.
...
Next review: before every release and no later than 2026-10-25.
