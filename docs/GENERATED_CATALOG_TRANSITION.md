...
- a `GeneratedTransition` wrapper with schema-typed direct root-field read and update methods, disposition-typed reason methods, and per-catalog typed effect/channel staging methods;
